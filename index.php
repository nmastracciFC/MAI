...
<body>
	...
	<div id="container">
		...
		<nav>
			<p id="logoText">#MyActiveIngredient</p>
			...
			<div class="social">
				...
				<a href="https://twitter.com/myactivingrednt" target="_blank"><img class="twitter" src="images/social-twitter.png" alt="twitter logo"></a>
